...
- [Screenshots](#screenshots)
  ...
  - [ℹ️ About & Settings](#-about--settings)
...
> “Smart, your path becomes, when GradMate you use.” — *Yoda*
...
> “I turned myself into an academic planner, Morty. I’m GradMate Rick!” — *Rick Sanchez*
...
|--------------|--------------|--------------|----------------|
| ![Onboarding1](screenshots/onboarding1.png) | ![Onboarding2](screenshots/onboarding2.png) | ![Onboarding3](screenshots/onboarding3.png) | ![SignIn](screenshots/signin.png) |

### 🏠 Home Screen & Posts
| Home (Empty) | Notice Post | Countdown | Birthday Post |
|--------------|-------------|-----------|---------------|
| ![HomeEmpty](screenshots/home_empty.png) | ![Notice](screenshots/notice_post.png) | ![Countdown](screenshots/countdown_post.png) | ![Birthday](screenshots/birthday_post.png) |
...
|------------|----------------|
| ![About](screenshots/about.png) | ![Admin](screenshots/admin.png) |

> “Clear your mind must be, and the UI will flow.” — *Yoda*
...
> “Pick the right APK, you must. Or crash you will.” — *Yoda*
...
Developed with ❤️ by **[Yasith Buddhima](https://www.linkedin.com/in/yasithbuddhima/)**  
...
To access the **Admin Console**, long-press on the developer name inside the app. 🛠️

> “Judge me by my code, do you?” — *Yoda*
...
> “Share your phone, not my code.” — *Rick, probably*
